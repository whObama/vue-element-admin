<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="菜单序号" width="60">
        <template slot-scope="scope">
          {{ scope.row.orderNum }}
        </template>
      </el-table-column>
    ...
    <el-dialog width="30%" :visible.sync="dialogVisible" :title="dialogType==='edit'?'修改菜单':'添加菜单'">
      <el-form :model="form" :rules="rules" ref="form" label-width="80px" label-position="left" class="demo-ruleForm">
        ...
        <el-form-item label="菜单序号" prop="orderNum">
          <el-tooltip class="item" effect="light" content="1~32 位字符；输入正整数" placement="top">
            <el-input v-model="form.orderNum" placeholder="菜单序号" :maxlength="num32" />
          </el-tooltip>
        </el-form-item>
...
import { name, valueRequired, indexCode, notRequiredCode, phone, num } from '@/utils/regExp'
...
export default {
  ...
  methods: {
    ...
    handleEdit(scope) {
      ...
      this.form.orderNum = scope.row.orderNum
