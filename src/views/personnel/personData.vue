<template>
  <div class="app-container">
      ...
      <el-row>
        ...
        <el-col :span="4">
          <div class="search-item">
            ...
            <el-select v-model="search.gender" placeholder="请选择" class="input-area">
              <el-option
        ...
        <el-col :span="4">
          <div class="search-item">
            ...
            <el-select v-model="search.certType" placeholder="请选择" class="input-area">
              <el-option
    ...
    <el-button class="top-button" type="primary" @click="handleAdd">添加人员</el-button>
    <el-button class="top-button" type="danger" :disabled="removeDisabled" @click="removeMore">批量删除人员</el-button>
    ...
    >
      ...
      <el-table-column align="center" label="人员图片" width="80">
        <template slot-scope="scope">
          <div class="mini-img" v-if="scope.row.faceUrl">
    ...
    <el-dialog width="30%" :visible.sync="dialogVisible" :title="dialogType==='edit'?'修改人员':'添加人员'">
      <el-form :model="form" :rules="rules" ref="form" label-width="80px" label-position="left" class="demo-ruleForm">
        <el-form-item label="姓名" prop="name">
          <el-tooltip class="item" effect="light" content="1~32 位字符；不含 ' / \ : * ?  < > | 这些特殊字符" placement="top">
            <el-input v-model="form.name" placeholder="姓名" :maxlength="num32" />
          </el-tooltip>
        </el-form-item>
        <el-form-item label="性别" prop="gender">
         <el-select style="width: 100%;" v-model="form.gender" placeholder="请选择" class="input-area">
            <el-option
        ...
        <el-form-item label="证件类型" prop="certType">
         <el-select style="width: 100%;" v-model="form.certType" placeholder="请选择" class="input-area">
            <el-option
              v-for="item in certTypeList"
              :key="item.value"
              :label="item.label"
        ...
        <el-form-item label="证件号码" prop="certNo">
          <el-tooltip class="item" effect="light" content="小于等于32个字符,只允许数字和字母" placement="top">
            <el-input placeholder="证件号码" v-model="form.certNo" :maxlength="num32"></el-input>
          </el-tooltip>
        </el-form-item>
        <el-form-item label="工号" prop="jobNo">
          <el-tooltip class="item" effect="light" content="小于等于32个字符,只允许数字和字母" placement="top">
            <el-input placeholder="工号" v-model="form.jobNo" :maxlength="num32"></el-input>
          </el-tooltip>
        </el-form-item>
        <el-form-item label="手机号码" prop="phone">
          <el-tooltip class="item" effect="light" content="1-11位数字" placement="top">
            <el-input placeholder="手机号码" v-model="form.phone" :maxlength="num11"></el-input>
          </el-tooltip>
        </el-form-item>
        <el-form-item label="上传图片" prop="faceUrl">
          <el-upload
            ...
            <i v-if="form.faceUrl" class="el-icon-delete upload-delete" @click.stop="removeUpload(form.faceUrl, form.indexCode)"></i>
...
<script>
import { queryPersonList, addPerson, deletePerson, updatePerson, uploadFile, removeFile } from '@/api/person'
...
export default {
  ...
  methods: {
    ...
    beforeUpload (file, fileList) {
      ...
      if (isRightType !== 'jpg' && isRightType !== 'png' && isRightType !== 'jpeg') {
    ...
    removeUpload(url, indexcode) {
      console.log(val)
      removeFile({ faceUrl: val, indexCode }).then(
        res => {
          if (res.code === '0') {
            this.$message({
              type: 'success',
    ...
    removeMore() {
      ...
      this.$confirm('确认从人员列表中删除' + this.multipleSelectData.length + '个人员吗?', '提示', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      })
